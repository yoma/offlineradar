      ...
      <div className="rounded-2xl border border-border bg-secondary/40 px-5 py-8 sm:px-8">
        {success ? (
          <div className="space-y-4" role="status" aria-live="polite">
            ...
            <p className="max-w-2xl text-[15px] leading-6 text-emerald-950/80">
              {success}
            </p>
            <p className="max-w-2xl text-[15px] leading-6 text-muted-foreground">
              We gaan ermee aan de slag. Eerst controleren we of de activiteit
              singlesgericht is volgens onze regels. Inzenden geeft geen garantie
              op publicatie.
            </p>
            <Button
              type="button"
              ...
              >
                ...
                <div className="space-y-3">
                  <label className="flex items-start gap-3 text-sm leading-6">
                    ...
                    />
                    <span>
                      Wil je op de hoogte gebracht worden wanneer we je tip
                      beoordeeld hebben?
                    </span>
                  </label>
                  ...
                  {notify ? (
                    <div className="space-y-2 pl-7">
                      ...
                      <p className="text-sm text-muted-foreground">
                        ...
                        melding te informeren, niet voor reclame of
                        nieuwsbrieven.
                      </p>
                    </div>
                  ) : null}
                ...
                {!submitEnabled ? (
                  <p className="rounded-xl border border-amber-200 bg-amber-50 px-4 py-3 text-sm text-amber-950">
                    Verzenden is tijdelijk niet beschikbaar. Probeer het later
                    opnieuw.
                  </p>
                ) : (
                  <p className="rounded-xl border border-border bg-white px-4 py-3 text-sm text-muted-foreground">
                    Tip wordt pas bevestigd nadat we hem veilig hebben
                    opgeslagen. Inzenden geeft geen garantie op publicatie.
                  </p>
                )}
