...
export const PREVIEW_IMPORT_DECISIONS: PreviewImportDecision[] = [
  ...
  },
  {
    ...
    startTime: null,
    endTime: null,
    startTimeDisplayNote: "startuur conflict: 19:00 vs 20:00 — nog te bevestigen",
    primarySourceUrl: "https://minglenight.be/",
    extraSources: [
      {
        sourceType: "ticket",
      ...
      },
      {
        ...
        sourceName: "IkWilEenTicket (redirect vanaf minglenight.be)",
        isPrimary: false,
      },
    ],
    changesVsPreview: [
      "minglenight.be redirect naar ikwileenticket.be (19u00).",
      "House of Entertainment blijft 20:00 vermelden.",
    ],
    conflicts: [
      "Starttijd conflict: ikwileenticket/minglenight → 19:00; houseofentertainment.be → 20:00.",
    ],
    reviewNotes: [
      "Datum/locatie OK (17 okt 2026, Antwerp Expo).",
      "under_review zolang starttijdconflict openstaat; niet gokken.",
    ],
    sourceOk: "partial",
  },
  {
